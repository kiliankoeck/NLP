...
# Point to the TEST results folder
...
# Main block needs to use the variables defined above
def main():
    entity_files = sorted(ENTITIES_DIR.glob("*_entities.json"))
    score_rows = []

    for json_file in entity_files:
        # We need to make sure load_doc_entities uses the MODELS list defined above
        # (It will if you copy the functions here)
