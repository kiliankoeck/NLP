...
if __name__ == "__main__":
    import sys
    input_folder = sys.argv[1] if len(sys.argv) > 1 else "data/test_set_json/"    #change to full dataset
    output_folder = sys.argv[2] if len(sys.argv) > 2 else "data/test_set_conllu/"   #change for full dataset
